    ...
    <div class="main_container">
      <div class="col-md-3 left_col">
        <div class="left_col scroll-view">
          <div class="navbar nav_title" style="border: 0;">
            <center>
              &nbsp;&nbsp;&nbsp;&nbsp;<a href="index.php" class="fa fa-cog fa-2x" style="color:#fff;">&nbsp;<span>
                  <font size="4.95" color="white" face="Helvetica Neue">GEEK ADMIN PAGE</font>
                </span></a>
            </center>
          </div>
            ...
            <div class="menu_section">
              <ul class="nav side-menu">
                ...
                <li><a><i class="fa fa-edit"></i> Data Post <span class="fa fa-chevron-down"></span></a>
                  <ul class="nav child_menu">
                    <li><a href="index.php?page=tampil_posts">Tampil Data</a></li>
                    <li><a href="index.php?page=tambah_posts">Tambah Data</a></li>
                  </ul>
                </li>
                <li><a><i class="fa fa-dollar"></i> Data Pricing <span class="fa fa-chevron-down"></span></a>
                  <ul class="nav child_menu">
                    <li><a href="index.php?page=tampil_pricing">Tampil Data</a></li>
                    <li><a href="index.php?page=tambah_pricing">Tambah Data</a></li>
                  </ul>
                </li>
                <li><a><i class="fa fa-envelope-square"></i> Data Message <span class="fa fa-chevron-down"></span></a>
                  <ul class="nav child_menu">
                    <li><a href="index.php?page=tampil_message">Tampil Data</a></li>
                  </ul>
                </li>
              </ul>
            </div>
      ...
      <div class="right_col" role="main">
        ...
        switch ($queries['page']) {
          case 'tampil_mhs':
            # code...
            include './team/tampil.php';
            break;
          case 'tambah_mhs':
            # code...
            include './team/tambah.php';
            break;
          case 'edit_mhs':
            # code...
          ...
          case 'tampil_posts':
            # code...
            include './posts/tampil.php';
            break;
          case 'tambah_posts':
            # code...
            include './posts/tambah.php';
            break;
          case 'edit_posts':
            # code...
            include './posts/edit.php';
            break;
          case 'edit_posts_save':
            # code...
            include './posts/edit.php';
            break;
          case 'tampil_pricing':
            # code...
            include './pricing/tampil.php';
            break;
          case 'tambah_pricing':
            # code...
            include './pricing/tambah.php';
            break;
          case 'edit_pricing':
            # code...
            include './pricing/edit.php';
            break;
          case 'edit_pricing_save':
            # code...
            include './pricing/edit.php';
            break;
          case 'tampil_message':
            # code...
            include './message/tampil.php';
            break;
          default:
            #code...
            include 'home.php';
