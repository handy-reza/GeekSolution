...
?>
	...
	<div class="container" style="margin-top:20px">
		<center><font size="6">Data Team</font></center>
		<hr>
					...
					while($data = mysqli_fetch_assoc($sql)){
						...
						<tr>
							...
							<td>
								...
								<a href="./team/delete.php?Nim='.$data['Nim'].'" class="btn btn-danger btn-sm" onclick="return confirm(\'Yakin ingin menghapus data ini?\')">Delete</a>
							</td>
						</tr>
						';
						$no++;
